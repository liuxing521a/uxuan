...
import org.itas.common.Utils.FileUtils;

public final class XResources {

  private static XClassLoader classLoaderWrapper = new XClassLoader();
  ...
  {
	  return FileUtils.getResourceAsInputStream(url);
  }
