...
import com.uxuan.util.json.asm.ASMException;
...
import com.uxuan.util.json.parser.Feature;
...
import com.uxuan.util.json.util.DeserializeBeanInfo;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type)
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", null);
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "deserialzeArrayMapping"
                                          , "(Lcom/xian/common/json/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;"
                                          , null, null);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanInt", "(C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanLong", "(C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanBoolean", "(C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFloat", "(C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanDouble", "(C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanString", "(C)Ljava/lang/String;");
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(fieldClass)));
                mw.visitVarInsn(ALOAD, 1);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getSymbolTable",
                                   "()Lcom/xian/common/json/parser/SymbolTable;");
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanEnum",
                                   "(Ljava/lang/Class;Lcom/xian/common/json/parser/SymbolTable;C)Ljava/lang/Enum;");
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(fieldClass)));
                    mw.visitVarInsn(BIPUSH, seperator);
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanStringArray",
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    if (i == 0) {
                        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "LBRACKET", "I");
                    } else {
                        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "COMMA", "I");
                    }
                    mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "LBRACKET", "I");
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "accept", "(II)V");
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                    mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/util/ASMUtils", "parseArray",
                                       "(Ljava/util/Collection;" //
                                               + "Lcom/xian/common/json/parser/deserializer/ObjectDeserializer;" //
                                               + "Lcom/xian/common/json/parser/DefaultJSONParser;" //
                ...
                if (!last) {
                    ...
                    mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "RBRACKET", "I");
                    mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "EOF", "I");
                }
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "accept", "(II)V");
                continue;
            }
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "COMMA", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "nextToken", "(I)V");
    ...
    void _deserialze(ClassWriter cw, Context context) {
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKESPECIAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "isSupportArrayToBean",
                               "(Lcom/xian/common/json/parser/JSONLexer;)Z");
            mw.visitJumpInsn(IFEQ, next_);
            //isSupportArrayToBean
            
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "token", "()I");
            mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "LBRACKET", "I");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanType", "(Ljava/lang/String;)I");

        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONLexerBase", "NOT_MATCH", "I");
        mw.visitJumpInsn(IF_ICMPEQ, super_);

        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getContext",
                           "()Lcom/xian/common/json/parser/ParseContext;");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "setContext",
                               "(Lcom/xian/common/json/parser/ParseContext;Ljava/lang/Object;Ljava/lang/Object;)Lcom/xian/common/json/parser/ParseContext;");
            mw.visitVarInsn(ASTORE, context.var("childContext"));
        }

        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, "com/xian/common/json/parser/JSONLexerBase", "matchStat", "I");
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONLexerBase", "END", "I");
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class //
                ...
                if (fieldClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, context.var("lexer"));
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "stringDefaultValue",
                                       "()Ljava/lang/String;");
                } else {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldBoolean", "([C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == byte.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldInt", "([C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldLong", "([C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldFloat", "([C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldDouble", "([C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldString",
                                   "([C)Ljava/lang/String;");
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldSymbol",
                                   "([CLcom/xian/common/json/parser/SymbolTable;)Ljava/lang/String;");
                mw.visitInsn(DUP);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(fieldClass))); // cast
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "scanFieldStringArray",
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "parseRest",
                           "(Lcom/xian/common/json/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 2);
        mw.visitVarInsn(ALOAD, 3);
        mw.visitMethodInsn(INVOKESPECIAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "deserialze",
                           "(Lcom/xian/common/json/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _isEnable(Context context, MethodVisitor mw, Feature feature) {
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/Feature", feature.name(), "Lcom/xian/common/json/parser/Feature;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "isEnabled", "(Lcom/xian/common/json/parser/Feature;)Z");
    }

    private void defineVarLexer(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getLexer", "()Lcom/xian/common/json/parser/JSONLexer;");
        mw.visitTypeInsn(CHECKCAST, "com/xian/common/json/parser/JSONLexerBase"); // cast
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitMethodInsn(INVOKESPECIAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "createInstance",
                               "(Lcom/xian/common/json/parser/DefaultJSONParser;)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, getType(context.getClazz())); // cast
            mw.visitVarInsn(ASTORE, context.var("instance"));
        }
    }
    ...
    private void _setContext(Context context, MethodVisitor mw) {
        ...
        mw.visitVarInsn(ALOAD, context.var("context"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "setContext",
                           "(Lcom/xian/common/json/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, context.var("childContext"));
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/ParseContext", "setObject", "(Ljava/lang/Object;)V");
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor mw, Label reset_) {
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "RBRACE", "I");
        mw.visitJumpInsn(IF_ICMPNE, reset_);
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "matchField", "([C)Z");
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/JSONToken", "NULL", "I");
        ...
        mw.visitMethodInsn(INVOKEINTERFACE, "com/xian/common/json/parser/deserializer/ObjectDeserializer", "getFastMatchToken", "()I");
        ...
        { // setContext
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "setContext",
                               "(Ljava/lang/Object;Ljava/lang/Object;)Lcom/xian/common/json/parser/ParseContext;");
            mw.visitInsn(POP);
        }
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          "Lcom/xian/common/json/parser/deserializer/ObjectDeserializer;");
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(itemType)));
        mw.visitVarInsn(ILOAD, context.var("i"));
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        mw.visitMethodInsn(INVOKEINTERFACE, "com/xian/common/json/parser/deserializer/ObjectDeserializer", "deserialze",
                           "(Lcom/xian/common/json/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, context.var(fieldInfo.getName() + "_asm"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "checkListResolve",
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> itemType) {
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getConfig", "()"
                                                                                         + "Lcom/xian/common/json/parser/ParserConfig;");
        mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(itemType)));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/ParserConfig", "getDeserializer",
                           "(Ljava/lang/reflect/Type;)Lcom/xian/common/json/parser/deserializer/ObjectDeserializer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getResolveStatus", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/DefaultJSONParser", "NeedToResolve", "I");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getLastResolveTask",
                           "()Lcom/xian/common/json/parser/DefaultJSONParser$ResolveTask;");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "getContext", "()"
                                                                                          + "Lcom/xian/common/json/parser/ParseContext;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser$ResolveTask"
                           , "setOwnerContext"
                           , "(Lcom/xian/common/json/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.getName());
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "getFieldDeserializer",
                           "(Ljava/lang/String;)Lcom/xian/common/json/parser/deserializer/FieldDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser$ResolveTask", "setFieldDeserializer",
                           "(Lcom/xian/common/json/parser/deserializer/FieldDeserializer;)V");

        mw.visitVarInsn(ALOAD, 1);
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/parser/DefaultJSONParser", "NONE", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/DefaultJSONParser", "setResolveStatus", "(I)V");
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "getFieldType",
    ...
    public FieldDeserializer createStringFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo)
...

        {
            MethodVisitor mw = cw.visitMethod(ACC_PUBLIC //
                                              , "<init>" //
                                              , "(Lcom/xian/common/json/parser/ParserConfig;Ljava/lang/Class;Lcom/xian/common/json/util/FieldInfo;)V", null, null);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 2);
            mw.visitVarInsn(ALOAD, 3);
            mw.visitMethodInsn(INVOKESPECIAL, getType(superClass), "<init>"
                               , "(Lcom/xian/common/json/parser/ParserConfig;Ljava/lang/Class;Lcom/xian/common/json/util/FieldInfo;)V");
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "<init>", "(Lcom/xian/common/json/parser/ParserConfig;Ljava/lang/Class;)V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "<init>",
                           "(Lcom/xian/common/json/parser/ParserConfig;Ljava/lang/Class;)V");

        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, "com/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer", "serializer",
                          "Lcom/xian/common/json/parser/deserializer/ASMJavaBeanDeserializer$InnerJavaBeanDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/parser/deserializer/JavaBeanDeserializer", "getFieldDeserializerMap",
                           "()Ljava/util/Map;");
        mw.visitInsn(POP);
    ...
    private void _createInstance(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "createInstance"
                                          , "(Lcom/xian/common/json/parser/DefaultJSONParser;Ljava/lang/reflect/Type;)Ljava/lang/Object;",
                                          null, null);
