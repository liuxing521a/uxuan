...
import static com.uxuan.util.json.util.ASMUtils.getDesc;
import static com.uxuan.util.json.util.ASMUtils.getType;
...
import com.uxuan.util.json.JSON;
import com.uxuan.util.json.JSONException;
import com.uxuan.util.json.annotation.JSONField;
import com.uxuan.util.json.annotation.JSONType;
import com.uxuan.util.json.asm.ClassWriter;
import com.uxuan.util.json.asm.FieldVisitor;
import com.uxuan.util.json.asm.Label;
import com.uxuan.util.json.asm.MethodVisitor;
import com.uxuan.util.json.asm.Opcodes;
import com.uxuan.util.json.util.ASMClassLoader;
import com.uxuan.util.json.util.ASMUtils;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "com/xian/common/json/serializer/ASMJavaBeanSerializer",
                 new String[] { "com/xian/common/json/serializer/ObjectSerializer" });
        ...
        mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(clazz)));
        mw.visitMethodInsn(INVOKESPECIAL, "com/xian/common/json/serializer/ASMJavaBeanSerializer", "<init>", "(Ljava/lang/Class;)V");
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc(fieldInfo.getDeclaringClass())));

            if (fieldInfo.getMethod() != null) {
                mw.visitLdcInsn(fieldInfo.getMethod().getName());
                mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/util/ASMUtils", "getMethodType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");

            } else {
                mw.visitLdcInsn(fieldInfo.getField().getName());
                mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/util/ASMUtils", "getFieldType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");
            }
...

        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "write",
                                "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V",
                                null, new String[] { "java/io/IOException" });

            mw.visitVarInsn(ALOAD, context.serializer()); // serializer
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "getWriter",
                               "()Lcom/xian/common/json/serializer/SerializeWriter;");
            ...
            if (jsonType == null || jsonType.alphabetic()) {
                ...
                mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "SortField",
                                  "Lcom/xian/common/json/serializer/SerializerFeature;");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
                                   "(Lcom/xian/common/json/serializer/SerializerFeature;)Z");
        ...
        // writeAsArray
        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "writeAsArray",
                                "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V",
                                null, new String[] { "java/io/IOException" });
    ...
    private void generateWriteAsArray(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "write", "(C)V");
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (propertyClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeIntAndChar", "(IC)V");

            } else if (propertyClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeLongAndChar", "(JC)V");

            } else if (propertyClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFloatAndChar", "(FC)V");

            } else if (propertyClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeDoubleAndChar", "(DC)V");

            } else if (propertyClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeBooleanAndChar", "(ZC)V");
            } else if (propertyClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeCharacterAndChar", "(CC)V");

            } else if (propertyClass == String.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeString",
                                   "(Ljava/lang/String;C)V");
            } else if (propertyClass.isEnum()) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeEnum", "(Ljava/lang/Enum;C)V");
            } else {
                ...
                if (format != null) {
                    ...
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "writeWithFormat",
                                       "(Ljava/lang/Object;Ljava/lang/String;)V");
                } else {
                    mw.visitVarInsn(ALOAD, context.fieldName());
                    if (property.getFieldType() instanceof Class<?> //
                        && ((Class<?>) property.getFieldType()).isPrimitive()) {
                        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "writeWithFieldName",
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "PrettyFormat",
                              "Lcom/xian/common/json/serializer/SerializerFeature;");
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
                               "(Lcom/xian/common/json/serializer/SerializerFeature;)Z");
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, context.getClassName(), "nature", "Lcom/xian/common/json/serializer/JavaBeanSerializer;");
            ...
            mw.visitVarInsn(ALOAD, 4);
            mw.visitVarInsn(ILOAD, 5);
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JavaBeanSerializer", "write",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
            mw.visitInsn(RETURN);
...

        {
            ...
            mw.visitVarInsn(ALOAD, 2);
            mw.visitVarInsn(ILOAD, 5);
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JavaBeanSerializer", "writeReference",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;I)Z");
...

        {
            ...
            mw.visitFieldInsn(GETFIELD, context.getClassName(), "nature", "Lcom/xian/common/json/serializer/JavaBeanSerializer;");
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JavaBeanSerializer", "isWriteAsArray",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;)Z");
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "getContext",
                               "()Lcom/xian/common/json/serializer/SerialContext;");
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "setContext",
                               "(Lcom/xian/common/json/serializer/SerialContext;Ljava/lang/Object;Ljava/lang/Object;I)V");
        }
        ...
        // SEPERATO
        {
            ...
            // mw.visitVarInsn(ALOAD, context.var("out"));
            // mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "WriteClassName",
            // "L" + "com/xian/common/json/serializer/SerializerFeature" + ";");
            // mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
            // "(" + "L" + "com/xian/common/json/serializer/SerializerFeature" + ";" + ")Z");
            // mw.visitJumpInsn(IFEQ, else_);

            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitVarInsn(ALOAD, context.paramFieldType());
            mw.visitVarInsn(ALOAD, context.obj());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "isWriteClassName",
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "write", "(Ljava/lang/String;)V");
            mw.visitVarInsn(BIPUSH, ',');
        ...
        mw.visitVarInsn(ALOAD, context.var("parent"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "setContext",
                           "(Lcom/xian/common/json/serializer/SerialContext;)V");
    ...
    private void _enum(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (writeEnumUsingToString) {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue",
    ...
    private void _long(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;J)V");
    ...
    private void _float(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;F)V");
    ...
    private void _double(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;D)V");
    ...
    private void _char(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;C)V");
    ...
    private void _boolean(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;Z)V");
    ...
    private void _byte(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;I)V");
    ...
    private void _list(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.var("out"));
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldName", "(Ljava/lang/String;)V");
...

        {
            ...
            mw.visitTypeInsn(CHECKCAST, "com/xian/common/json/serializer/ObjectSerializer"); // cast to string
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(com.uxuan.util.json.asm.Type.getType(getDesc((Class<?>) elementType)));
                    mw.visitLdcInsn(property.getSerialzeFeatures());
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "writeWithFieldName",
                                       "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                } else {
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/JSONSerializer", "popContext", "()V");
        }
    ...
    private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (property.getField() != null) {
            if (Modifier.isTransient(property.getField().getModifiers())) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "SkipTransientField",
                                  "Lcom/xian/common/json/serializer/SerializerFeature;");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
                                   "(Lcom/xian/common/json/serializer/SerializerFeature;)Z");
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "applyName",
                           "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;)Z");
        mw.visitJumpInsn(IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "writeBefore",
                           "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _after(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "writeAfter",
                           "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _notWriteDefault(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitVarInsn(ALOAD, context.var("out"));
        mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "NotWriteDefaultValue",
                          "Lcom/xian/common/json/serializer/SerializerFeature;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
                           "(Lcom/xian/common/json/serializer/SerializerFeature;)Z");
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
            ...
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "apply",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC,
                           "com/xian/common/json/serializer/FilterUtils",
                           "processValue",
                           "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, "com/xian/common/json/serializer/FilterUtils", "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC,
                               "com/xian/common/json/serializer/FilterUtils",
                               "processKey",
                               "(Lcom/xian/common/json/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC,
                               "com/xian/common/json/serializer/FilterUtils",
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        if (!writeNull) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, "com/xian/common/json/serializer/SerializerFeature", "WriteMapNullValue",
                              "Lcom/xian/common/json/serializer/SerializerFeature;");
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "isEnabled",
                               "(Lcom/xian/common/json/serializer/SerializerFeature;)Z");
            mw.visitJumpInsn(IFEQ, _else);
        ...
        if (propertyClass == String.class || propertyClass == Character.class) {
            if (writeNullStringAsEmpty) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldNullString",
            ...
            if (writeNullNumberAsZero) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldNullNumber",
                                   "(CLjava/lang/String;)V");
            }
        } else if (propertyClass == Boolean.class) {
            if (writeNullBooleanAsFalse) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldNullBoolean",
                                   "(CLjava/lang/String;)V");
            }
        } else if (Collection.class.isAssignableFrom(propertyClass) || propertyClass.isArray()) {
            if (writeNullListAsEmpty) {
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldEmptyList",
                                   "(CLjava/lang/String;)V");
            } else {
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldNullList",
                                   "(CLjava/lang/String;)V");
            }
        } else {
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/xian/common/json/serializer/SerializeWriter", "writeFieldNull",
                               "(CLjava/lang/String;)V");
        }
