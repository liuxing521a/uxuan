 ...
 */
class FDListProvider extends FDContainerProvider 
	...
	public static final FDListProvider PROVIDER = new FDListProvider();
	
	private FDListProvider() {
	}
	...
	public String getResultSet(CtField field) throws Exception {
		...
		final String containerName = newContainer(field, "java.util.ArrayList");
