 ...
 */
class FDEnumStringProvider extends AbstractFieldProvider 
	...
	public static final FDEnumStringProvider PROVIDER = new FDEnumStringProvider();
	
	private FDEnumStringProvider() {
	}
