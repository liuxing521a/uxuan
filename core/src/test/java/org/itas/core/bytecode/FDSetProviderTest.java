...
public class FDSetProviderTest extends AbstreactFieldProvider {

	@Before
	public void setUP() throws NotFoundException {
		clazz = ClassPool.getDefault().get(Hero.class.getName());
		provider = FDSetProvider.PROVIDER;
	}
	...
	public void typeTest() throws NotFoundException, Exception {
		...
		for (CtField field : fields) {
			if (field == this.field || javassistType.set_.subtypeOf(field.getType())) {
	...
	public void javaBaseStatementTest() throws Exception {
		...
		String expected = 
				...
				+ "\n\t\t\t"
				+ "java.util.Set valueList_ = new java.util.LinkedHashSet(8);"
				+ "\n\t\t\t"
	...
	public void simpleStatementTest() throws Exception {
		...
		String expected = "\n\t\t"
				...
				+ "String[] valueArray_ = parseArray(value_);" + "\n\t\t\t"
				+ "java.util.Set valueList_ = new java.util.HashSet(8);" + "\n\t\t\t"
				+ "for (int i = 0; i < valueArray_.length; i ++) {" + "\n\t\t\t\t"
	...
	public void resourceResultTest() throws Exception {
		...
		String expected = 
				...
				+ "String[] valueArray_ = parseArray(value_);"
				+ "\n\t\t\t"
				+ "java.util.Set valueList_ = new java.util.HashSet(16);"
				+ "\n\t\t\t"
				+ "for (int i = 0; i < valueArray_.length; i ++) {"
				+ "\n\t\t\t\t"
